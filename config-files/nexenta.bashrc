...
shopt -s nocasematch
shopt -s nocaseglob
## End : Non-standard shopt

## Begin : All other environment exports
export PATH=~/bin:$PATH
if [[ -d /usr/dtrctkit/bin ]]; then
    export PATH=$PATH:/usr/dtrctkit/bin
fi
## End : All other environment exports
...
alias s='sudo'
alias acl_ls='/usr/sun/bin/ls'
alias acl_chmod='/usr/sun/bin/chmod'
