...
#
###############################################################################
## Add any aditional distros here, assuming that we can correct read, and set
## the DISTRO variable correctly (see vanilla-svr.bashrc for setting DISTRO)
if [[ ! -z "${DISTRO}" ]]; then
    case "${DISTRO}" in
        "centos") ## add aliases for CentOS servers here
            ;;
        "ubuntu") ## add aliases for Ubuntu servers here
            PAGER=/usr/bin/less
            ...
            export PAGER
            ;;
        *) echo "Distribution of your GNU/Linux System is Unknown"
    esac
fi
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Adhoc Add alias to ~/.bash_aliases file
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	if [[ $(which ecryptfsd &>/dev/null) ]]; then # Create aliases if ecryptfs exists
